...
while boolRunAgain == 1:
    profile = 0
    useDefault = input("Use default settings? Y/N")
    useDefault = useDefault[0].upper()
    if useDefault == "Y":
        numOfPurchases = 1000
        authLow = 30
        authHigh = 70
        ...
        authLow = float(input("low end of purchases(1-50): "))
    ...
    #amount of times a theft was unnoticed
    goodTheft = 0

    #amount of times the system went off
    systemTriggers = 0
    ...
    # we build our initial purchase and modify only if fraud is true.
        ...
        if fraudIntelligence == "Y":
            # low purchases
            if fraudStrategy == 0:
                newPurchase = [(random.randint(1,authLow)/10)]
            # mixed purchases 
            if fraudStrategy == 1:
    ...
    # We mark it fraud or not at the 1st index.
        ...
        if (newPurchase[1] == 1 and newPurchase[2] == 1):
            ...
            systemTriggers = systemTriggers + 1
    ...
    print("Amount of thefts: " + str(theftCount))
    print("Amount of successful thefts: " + str(goodTheft))
    print("Amount of times the system flagged: " + str(systemTriggers))
    print(flagAuthentic)
